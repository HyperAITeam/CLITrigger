...
const translations = {
  en: {
    ...
    'planner.exportTooltip': 'Export planner items to a JSON file',
    'planner.exportError': 'Export failed',
    'planner.import': 'Import',
    'planner.importTooltip': 'Import planner items from a JSON file',
    'planner.importSuccess': 'Imported {items} item(s) and {tags} tag(s).',
    'planner.importError': 'Import failed',
    'planner.importInvalidJson': 'File is not valid JSON',
  ...
  ko: {
    ...
    'planner.noDueDate': '—',
    'planner.export': '내보내기',
    'planner.exportTooltip': '플래너 항목을 JSON 파일로 내보내기',
    'planner.exportError': '내보내기 실패',
    'planner.import': '가져오기',
    'planner.importTooltip': 'JSON 파일에서 플래너 항목 가져오기',
    'planner.importSuccess': '{items}개 항목과 {tags}개 태그를 가져왔습니다.',
    'planner.importError': '가져오기 실패',
    'planner.importInvalidJson': '유효한 JSON 파일이 아닙니다',
