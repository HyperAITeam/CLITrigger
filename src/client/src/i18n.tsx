...
const translations = {
  en: {
    ...
    'todo.continue': 'Continue in worktree: Run a follow-up prompt in the same worktree/branch, preserving prior work (new round).',
  ...
  ko: {
    ...
    'todo.continue': '이어서: 같은 워크트리/브랜치에서 후속 프롬프트를 실행해 기존 작업을 이어갑니다 (새 라운드).',
