...
- **Routes**: `/` (ProjectList), `/review` (cross-project Morning Review Queue), `/projects/:id` (ProjectDetail — hosts Todos, Sessions, Planner, Analytics, Discussions, Schedules, Git, and plugin tabs), `/projects/:id/discussions/:discussionId` (DiscussionDetail).
